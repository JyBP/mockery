...
func (s *GeneratorSuite) getGenerator(
	filepath, interfaceName string, inPackage bool, prefix string,
) *Generator {
	return NewGenerator(
		s.getInterfaceFromFile(filepath, interfaceName), pkg, inPackage, prefix,
	)
}

func (s *GeneratorSuite) checkGeneration(
	filepath, interfaceName string, inPackage bool, prefix string, expected string,
) *Generator {
	generator := s.getGenerator(filepath, interfaceName, inPackage, prefix)
...
func (s *GeneratorSuite) TestGeneratorPrefix() {
	expected := `// PrefixRequester is an autogenerated mock type for the Requester type
type PrefixRequester struct {
	mock.Mock
}

// Get provides a mock function with given fields: path
func (_m *PrefixRequester) Get(path string) (string, error) {
	ret := _m.Called(path)
...
`
	s.checkGeneration(testFile, "Requester", false, "Prefix", expected)
}
